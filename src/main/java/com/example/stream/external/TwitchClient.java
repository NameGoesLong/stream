...
import com.example.stream.entity.Game;
import com.example.stream.entity.Item;
import com.example.stream.entity.ItemType;
...
public class TwitchClient {
    private static final String TOKEN = "Bearer TOKEN_NAME";
    ...
    // Search Url for stream
    private static final String STREAM_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/streams?game_id=%s&first=%s";
    // Search Url for video
    private static final String VIDEO_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/videos?game_id=%s&first=%s";
    // Search Url for small clips
    private static final String CLIP_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/clips?game_id=%s&first=%s";
    // Search Url, handles corner cases
    ...
    private String buildGameURL(String url, String gameName, int limit){
        // Default: top game url
        if(gameName.equals("")){
            return String.format(url, limit);
        }else{  // Search game url
            try{
    ...
    private List<Item> searchStreams(String gameId, int limit) throws TwitchException {
        ...
        // Notice in some return, it might not have a streaming URL return
        // Thus we use TWITCH_BASE_URL to snip and paste the URL room
    ...
    public  List<Item> searchByType(String gameId, ItemType type, int limit){
        ...
        for (Item item : items) {
            ...
            // TODO: we could extract setType() for all three functions and put it here
        }
        return items;
    }
