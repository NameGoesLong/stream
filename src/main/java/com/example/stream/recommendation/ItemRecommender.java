package com.example.stream.recommendation;
...
public class ItemRecommender {
    ...
    private List<Item> recommendByTopGames(ItemType type, List<Game> topGames) throws RecommendationException {
        ...
        // This is used to return only 20 search results, another solution is to return at line 33
        outerloop:
    ...
    // Return a map of Item objects as the recommendation result. Keys of the may are [Stream, Video, Clip].
    // Each key is corresponding to a list of Items objects, each item object is a recommended item based on the top games currently on Twitch.
