...
public class Item {
    // This property could be perfectly matched by json => final
    @JsonProperty("id")
    ...
    // 1.   There are some discrepancy between some json return
    //      need JsonAlias to cover all situations
    // 2.   This property need to be modified => no final
